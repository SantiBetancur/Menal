...
export const TestStress = () => {
  return (
    ...
    <section className='section' id="p0">
      ...
      <label>
          <input type="radio" value="1" name="p0"/> Nunca
      </label>
      <label>
          <input type="radio" value="2" name="p0"/> Casi nunca
      </label>
      <label>
          <input type="radio" value="3" name="p0"/> De vez en cuando
      </label>
      <label>
          <input type="radio" value="4" name="p0"/> A menudo
      </label>
      <label>
          <input type="radio" value="5" name="p0"/> Muy a menudo
      </label>
    </section>
    ...
    <section className='section' id="p1">
      ...
      <label>
          <input type="radio" value="1" name="p1"/> Nunca
      </label>
      <label>
          <input type="radio" value="2" name="p1"/> Casi nunca
      </label>
      <label>
          <input type="radio" value="3" name="p1"/> De vez en cuando
      </label>
      <label>
          <input type="radio" value="4" name="p1"/> A menudo
      </label>
      <label>
          <input type="radio" value="5" name="p1"/> Muy a menudo
      </label>
    </section>
    ...
    <section className='section' id="p2">
      ...
      <label>
          <input type="radio" value="1" name="p2"/> Nunca
      </label>
      <label>
          <input type="radio" value="2" name="p2"/> Casi nunca
      </label>
      <label>
